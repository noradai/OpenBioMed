import numpy as np
from sklearn.metrics import roc_auc_score, cohen_kappa_score, auc, precision_recall_curve
...
if __name__ == '__main__':
    ...
    y_predcls = np.array([0.99, 0.59, 0, 0.68, 0, 0.68, 0, 0.51])
